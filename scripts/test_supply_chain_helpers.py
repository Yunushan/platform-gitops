...
def main() -> int:
    ...
    for playbook, required in (
        (
            ...
            (
                ...
                "apply --server-side --force-conflicts --field-manager=platform-gitops -f -",
    ...
    for script in RKE2_BOOTSTRAP_SCRIPTS:
        try:
            ...
            assert_contains(
                ...
                "umask 077",
                "RKE2_INSTALLER_MAX_BYTES=$((2 * 1024 * 1024))",
                'export INSTALL_RKE2_TYPE="server"',
                'export INSTALL_RKE2_VERSION="${RKE2_VERSION}"',
                "unset INSTALL_RKE2_CHANNEL",
                "10#${timeout_value}",
                "for required_command in chmod chown curl",
                "trap 'exit 143' TERM",
                "--retry-all-errors",
                "--proto '=https'",
                "--proto-redir '=https'",
    ...
    try:
        ...
        assert_contains(
            ...
            'regexTarget = "match"',
            ".*[.][.][.].*",
            'description = "Reviewed vendored private-key examples in their introducing commit"',
            'commits = ["2ee7db41c7d02791b3bf21db00371e523cf948db"]',
