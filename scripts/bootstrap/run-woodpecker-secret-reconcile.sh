...
env_file=""
if [[ -n "${PLATFORM_WOODPECKER_REPAIR_ENV_FILE:-}" ]]; then
  env_file="${PLATFORM_WOODPECKER_REPAIR_ENV_FILE}"
...
export PLATFORM_APP_SECRET_REQUIRE_HARBOR_DATABASE=false
export PLATFORM_APP_SECRET_REQUIRE_HARBOR_REDIS=false
export PLATFORM_APP_SECRET_REQUIRE_HARBOR_REGISTRY_STORAGE=false
