...
ALLOWED_NO_LOG_TASKS = {
    ...
    ("ansible/playbooks/manage-platform-tls.yml", "Copy wildcard TLS certificate to first server"),
    ("ansible/playbooks/manage-platform-tls.yml", "Copy wildcard TLS key to first server"),
    ("ansible/playbooks/manage-platform-tls.yml", "Validate wildcard TLS material and apply namespace-local secrets"),
    ("ansible/playbooks/install-rke2.yml", "Reconcile RKE2 etcd S3 snapshot configuration secret"),
