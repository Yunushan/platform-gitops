...
def main() -> None:
    ...
    for argocd_values, label, repo_replicas in (
        ...
        for needle in (
            ...
            "  startupProbe:\n    enabled: true\n    initialDelaySeconds: 10\n    periodSeconds: 10\n    timeoutSeconds: 10\n    failureThreshold: 60",
            f"      cpu: {'200m' if argocd_values == premium_argocd_values else '500m'}\n      memory: 512Mi\n    limits:\n      memory: 2Gi",
            "applicationSet:\n  replicas: 2\n  resources:\n    requests:\n      cpu: 100m\n      memory: 128Mi\n    limits:\n      memory: 512Mi",
            "redis-ha:\n  enabled: true\n  haproxy:\n    deploymentStrategy:\n      type: RollingUpdate\n      rollingUpdate:\n        maxSurge: 0\n        maxUnavailable: 1\n    resources:\n      requests:\n        cpu: 50m\n        memory: 64Mi\n      limits:\n        memory: 128Mi",
            "  redis:\n    resources:\n      requests:\n        cpu: 100m\n        memory: 128Mi\n      limits:\n        memory: 512Mi",
            "    sentinel:\n      resources:\n        requests:\n          cpu: 50m\n          memory: 64Mi\n        limits:\n          memory: 128Mi",
            ...
            f"  resources:\n    requests:\n      cpu: {'250m' if argocd_values == premium_argocd_values else '500m'}\n      memory: 1Gi\n    limits:\n      memory: 2Gi",
    ...
    for velero_values, label in (
        ...
        for needle in (
            ...
            "resources:\n  requests:\n    cpu: 100m\n    memory: 256Mi\n  limits:\n    memory: 512Mi",
            f"nodeAgent:\n  resources:\n    requests:\n      cpu: {'100m' if velero_values == premium_velero_values else '250m'}\n      memory: 256Mi\n    limits:\n      memory: 1Gi",
    ...
    for needle in (
        ...
        "Wait for Longhorn to reclaim eligible orphan data",
    ...
    for needle in (
        ...
        "PLATFORM_WOODPECKER_REPAIR_SEED_BASE_URL",
        "PLATFORM_WOODPECKER_REPAIR_SEED_BASE_REF",
        "PLATFORM_WOODPECKER_REPAIR_ALLOW_EMPTY_SEED",
        'PLATFORM_SEED_GIT_EXPECTED_HEAD="${seed_destination_head:-absent}"',
        "seed_destination_refs=",
        ...
        'config user.name "${seed_git_user_name:-Platform GitOps Repair}"',
        'config user.email "${seed_git_user_email:-platform-gitops-repair@localhost}"',
    ...
    for needle in (
        ...
        "Reconcile guarded data-bearing Longhorn attachment deadlocks",
    ...
    for needle in (
        ...
        "conflicting-csi-ticket-target-present",
        "other-active-consumer-present",
        "old-successful-native-attachment-cardinality-not-one",
        "action=recycle-stale-native-attachment",
        "stale-native-attachment-recycle-timeout",
    ...
    for needle in (
        ...
        "woodpecker-postgres-ca-source-does-not-verify-active-server",
        "recover_immutable_server_statefulset",
        'StatefulSet.apps "woodpecker-server" is invalid: spec: Forbidden: updates to statefulset spec',
    ...
    for needle in (
        ...
        "Report Woodpecker node-host probe limitations",
        "NAMESPACE=woodpecker",
        "woodpecker-no-ready-grpc-backends",
