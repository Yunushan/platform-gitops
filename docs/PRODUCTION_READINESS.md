...
| JSON parsing is unambiguous | `python scripts/test_strict_json_contract.py`; all first-party production decoders reject duplicate object keys, non-standard numeric constants, and finite-range overflow while preserving normal JSON syntax errors |
